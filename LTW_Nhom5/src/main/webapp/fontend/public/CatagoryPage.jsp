...
<footer class="footer">
    <div class="footer-container">
        ...
        <div class="footer-column">
            ...
            <ul>
                ...
                <li><a href="../nguoiB/chat.jsp">Liên hệ</a></li>
            </ul>
        </div>
        ...
        <div class="footer-column">
            ...
            <div class="social-links">
                ...
                <a href="https://www.tiktok.com/@comics_store" title="TikTok"><i class="fab fa-tiktok"></i></a>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <p>© 2025 <strong>ComicStore</strong> — All rights reserved.</p>
    </div>
</footer>
