        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    ...
                    <p class="mb-4">Hãy nhập đăng nhập để bắt đầu sử dụng dịch vụ mua sắm.</p>
                    <form action="#" method="post">
                        <div class="form-group first">
                            <label for="username">Username</label>
                            <input type="text" class="form-control" placeholder="Tên đăng nhập hoặc gmail" id="username">
                        </div>
