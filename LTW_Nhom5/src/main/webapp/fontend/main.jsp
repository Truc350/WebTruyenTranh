...
<main class="container">
    <div class="cart-details">
        ...
        <div class="cart-actions">
            <a href="store.html" class="button continue-shopping"> <i class="fa-solid fa-arrow-left"></i> TIẾP TỤC
                XEM SẢN PHẨM</a>
        </div>
    </div>
    ...
    <div class="payment-form">
        ...
        <div class="order-summary">
            ...
            <div class="group-button">
                ...
                <button type="reset" class="button-cancel">HỦY</button>
            </div>
        </div>
    </div>
    <div id="success-modal" class="modal">
        <div class="modal-content success-modal-content">
            ...
            <button id="back-to-home" class="button">Quay về trang chủ</button>
        </div>
    </div>
</main>
